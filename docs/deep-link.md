...
| 커스텀 스킴 | 유니버셜 링크 | 화면 |
|---|---|---|
| `skkuverse://` | `https://skkuverse.com` | 홈 (campus 탭) |
| `skkuverse://campus` | `https://skkuverse.com/campus` | 캠퍼스 탭 |
| `skkuverse://transit` | `https://skkuverse.com/transit` | 교통 탭 |
| `skkuverse://map/hssc` | `https://skkuverse.com/map/hssc` | 인사캠 지도 |
| `skkuverse://search` | `https://skkuverse.com/search` | 건물/공간 검색 |
...
- 유니버셜 링크: `https://skkuverse.com/map/hssc` → 스킴+호스트 벗기고 경로 추출 → `/map/hssc`

호스트에 `.`이 포함되면 도메인으로 판단하여 호스트를 제거한다.
...
xcrun simctl openurl booted "https://skkuverse.com/search"
xcrun simctl openurl booted "https://skkuverse.com/webview?url=https://evil.com"
```
