...
| [bottom-sheet-system.md](explanation/bottom-sheet-system.md) | The one sheet component: three named detents, the float-vs-attach rule that decides glass or opaque, and the native constraints behind the card |
