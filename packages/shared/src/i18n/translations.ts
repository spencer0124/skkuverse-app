...
const ko = {
  ...
  'auth.deleteAccountReason.notUsed': '앱을 자주 안 써요',
  'auth.deleteAccountReason.tooManyNotifs': '알림이 너무 많아요',
  'auth.deleteAccountReason.noValue': '원하는 정보가 없어요',
...
const en: TranslationMap = {
  ...
  'auth.deleteAccountReason.notUsed': "I don't use the app often",
  'auth.deleteAccountReason.tooManyNotifs': 'Too many notifications',
  'auth.deleteAccountReason.noValue': "It doesn't have what I need",
...
const zh: TranslationMap = {
  ...
  'auth.deleteAccountReason.notUsed': '不常使用',
  'auth.deleteAccountReason.tooManyNotifs': '通知太多',
  'auth.deleteAccountReason.noValue': '没有想要的信息',
