...
const ko = {
  ...
  'auth.deleteAccount': '회원 탈퇴',
  'auth.deleteAccountConfirmTitle': '회원 탈퇴하시겠어요?',
  'auth.deleteAccountConfirmDescription':
    '계정과 데이터가 영구적으로 삭제돼요.\n저장한 공지와 알림 설정은 복구할 수 없어요.',
  'auth.deleteAccountNext': '다음',
  'auth.deleteAccountAction': '탈퇴하기',
  'auth.deleteAccountSkip': '건너뛰고 탈퇴',
  'auth.deleteAccountFeedbackTitle': '잠깐, 떠나는 이유를 알려주실 수 있어요?',
  'auth.deleteAccountFeedbackSubtitle': '익명으로 수집해요. 더 좋은 앱을 만드는 데 써요.',
  'auth.deleteAccountReason.not_used': '앱을 자주 안 써요',
  'auth.deleteAccountReason.too_many_notifs': '알림이 너무 많아요',
  'auth.deleteAccountReason.no_value': '원하는 정보가 없어요',
  'auth.deleteAccountReason.bugs': '오류가 자주 발생해요',
  'auth.deleteAccountReason.other': '기타',
  'auth.deleteAccountReason.otherPlaceholder': '자유롭게 적어주세요 (선택)',
  'auth.deleteAccountErrorTitle': '탈퇴 처리 실패',
  'auth.deleteAccountError': '잠시 후 다시 시도해주세요. 문제가 계속되면 문의해주세요.',
  ...
  'notices.retry': '다시 시도',
  'notices.edited': '수정됨',
  // AI 한줄요약이 없는 공지의 리스트 셀 대체 문구. 요약 줄을 비워 두면
  // 행 높이가 들쭉날쭉해지고 "요약이 아직 안 왔나" 하는 인상을 주므로,
  // 어디를 봐야 하는지 알려 주는 문구로 채운다.
  'notices.summaryFallbackAttachment': '첨부파일 참고',
  'notices.summaryFallback': '공지 참고',
  'notices.attachments': '첨부파일',
  'notices.preview': '미리보기',
  'notices.download': '다운로드',
  'notices.openOriginal': '원본 페이지 열기',
  'notices.openInBrowser': '홈페이지에서 보기',
  'notices.refPhone': '전화번호',
  'notices.refEmail': '이메일',
  'notices.siblingPrev': '이전글',
  'notices.siblingNext': '다음글',
  'notices.siblingPrevEmpty': '이전글이 없습니다.',
  'notices.siblingNextEmpty': '다음글이 없습니다.',
  'notices.viewSource': '공지 자세히 보기',
  'notices.sourceSheetTitle': '공지 원문',
  'notices.reactionLike': '좋아요',
  'notices.reactionFire': '불',
  'notices.reactionWow': '신기해요',
  'notices.reactionSad': '아쉬워요',
  'notices.save': '저장',
  'notices.share': '공유',
  'notices.unsave': '저장 취소',
  'notices.saved': '보관함',
  'notices.savedEmpty': '저장된 공지가 없어요',
  'notices.saveFailed': '저장에 실패했어요',
  'notices.authRequired': '로그인이 필요해요',
  'notices.deletedTombstoneTitle': '원본이 삭제된 공지예요',
  'notices.deletedTombstoneDescription':
    '학교 사이트에서 더 이상 볼 수 없는 공지지만, 보관함에 저장한 정보는 그대로 남아있어요.',
  'notices.deletedRemoveCta': '보관함에서 제거',
  'notices.deletedKeepCta': '그대로 두기',
  'notices.views': '조회 {0}',
  ...
  'feedback.reviewPrompt.bookmarkTitle': '챙겨두고 싶은 공지를 찾으셨네요!\n스꾸버스, 잘 쓰고 계신가요?',
  'feedback.reviewPrompt.shuttleTitle': '셔틀 시간표 자주 확인하시네요!\n스꾸버스, 잘 쓰고 계신가요?',
  'feedback.reviewPrompt.positiveCta': '좋아요',
  'feedback.reviewPrompt.negativeCta': '아쉬워요',
  'feedback.reviewPrompt.negativePlaceholder': '어떤 부분이 아쉬웠는지 알려주세요',
  'feedback.reviewPrompt.negativeSubmit': '보내기',
  'feedback.reviewPrompt.thanks': '소중한 의견 감사합니다',
  'feedback.reviewPrompt.retry': '보내지 못했어요',
  'notices.copied': '복사했어요',
  'notices.endOfList': '더 이상 공지가 없어요',
  'notices.sectionToday': '오늘',
  'notices.sectionRecent7': '최근 7일',
  ...
  'onboarding.landingSubtitle': '학과 공지를 AI가 요약해드려요',
  'onboarding.landingCta': '시작하기',
  'onboarding.landingExistingAccountCta': '이미 가입한 적 있어요',
  'onboarding.next': '다음',
  'onboarding.skip': '건너뛸래요',
  'onboarding.campusTitle': '어느 캠퍼스예요?',
  'onboarding.campusSubtitle': '맞는 공지만 모아드릴게요',
  'onboarding.hsscName': '인문사회과학캠퍼스',
  ...
  'onboarding.primaryDeptUnsupportedHelp': '내 학과가 없어요',
  'onboarding.deptSearchPlaceholder': '학과 이름',
  'onboarding.interestDeptTitle': '더 보고 싶은\n학과 있어요?',
  'onboarding.interestDeptSubtitle': '4개까지 고를 수 있어요',
  'onboarding.primaryTag': '대표',
  'onboarding.loginTitle': '마지막이에요',
  'onboarding.loginSubtitle': '성대생만 볼 수 있게,\n학교 계정으로 로그인할게요',
  'onboarding.loginCta': '성균관대 계정으로 시작하기',
  'onboarding.summaryCampus': '캠퍼스',
  'onboarding.summaryPrimaryDept': '대표 학과',
  'onboarding.summaryInterestDept': '관심 학과',
  'onboarding.summaryNone': '없음',
  'onboarding.summaryPrimaryNone': '건너뜀',
  'onboarding.notificationTitle': '공지를 빠르게 받아보세요',
  ...
  'onboarding.exitTitle': '나가면 처음부터 다시 해야 해요',
  'onboarding.exitDescription': '정말 나갈까요?',
  'onboarding.exitContinue': '계속하기',
  'onboarding.exitLeave': '나가기',
  ...
  'settings.licenses': '약관 및 정책',
  'settings.licensesSubtitle': '정책 및 정보 제공처',
  'settings.tos': '서비스 이용약관',
  'settings.attributions': '정보 제공처',
  ...
  'notifications.essential': '필수 알림',
  'notifications.services': '다른 서비스',
  'notifications.notices': '공지',
  'notifications.subscribedDepts': '구독한 학과',
  'notifications.editDept': '학과 추가·편집',
  ...
  'notifications.enableSheetTitle': '공지 알림 받기',
  'notifications.enableSheetDescription': '중요한 학사·장학 공지를 푸시로 받을 수 있어요',
  'notifications.enableSheetCta': '알림 켜기',
...
const en: TranslationMap = {
  ...
  'auth.deleteAccountConfirmTitle': 'Delete your account?',
  'auth.deleteAccountConfirmDescription':
    'Your account and data will be permanently deleted.\nSaved notices and notification settings cannot be recovered.',
  'auth.deleteAccountNext': 'Next',
  'auth.deleteAccountAction': 'Delete',
  'auth.deleteAccountSkip': 'Skip and delete',
  'auth.deleteAccountFeedbackTitle': "One moment — could you tell us why you're leaving?",
  'auth.deleteAccountFeedbackSubtitle': 'Collected anonymously to help us improve.',
  'auth.deleteAccountReason.not_used': "I don't use the app often",
  'auth.deleteAccountReason.too_many_notifs': 'Too many notifications',
  'auth.deleteAccountReason.no_value': "It doesn't have what I need",
  'auth.deleteAccountReason.bugs': 'I run into bugs often',
  'auth.deleteAccountReason.other': 'Other',
  'auth.deleteAccountReason.otherPlaceholder': 'Tell us more (optional)',
  'auth.deleteAccountErrorTitle': 'Could not delete account',
  'auth.deleteAccountError': 'Please try again later. If the problem persists, contact us.',
  ...
  'notices.summaryFallbackAttachment': 'See attachment',
  'notices.summaryFallback': 'See notice',
  'notices.attachments': 'Attachments',
  'notices.preview': 'Preview',
  'notices.download': 'Download',
  'notices.openOriginal': 'Open original page',
  'notices.openInBrowser': 'View on website',
  'notices.refPhone': 'Phone',
  'notices.refEmail': 'Email',
  'notices.siblingPrev': 'Previous',
  'notices.siblingNext': 'Next',
  'notices.siblingPrevEmpty': 'No previous notice.',
  'notices.siblingNextEmpty': 'No next notice.',
  'notices.viewSource': 'Read full notice',
  'notices.sourceSheetTitle': 'Full notice',
  'notices.reactionLike': 'Like',
  'notices.reactionFire': 'Hot',
  'notices.reactionWow': 'Wow',
  'notices.reactionSad': 'Too bad',
  'notices.save': 'Save',
  'notices.share': 'Share',
  'notices.unsave': 'Remove bookmark',
  'notices.saved': 'Saved',
  'notices.savedEmpty': 'No saved notices yet',
  'notices.saveFailed': "Couldn't save",
  'notices.authRequired': 'Sign in required',
  'notices.deletedTombstoneTitle': 'This notice was removed at the source',
  'notices.deletedTombstoneDescription':
    "It's no longer available on the school's site, but what you saved is still here.",
  'notices.deletedRemoveCta': 'Remove from saved',
  'notices.deletedKeepCta': 'Keep it',
  ...
  'feedback.reviewPrompt.bookmarkTitle': 'Found a notice worth keeping!\nEnjoying Skkuverse so far?',
  'feedback.reviewPrompt.shuttleTitle': 'Checking the shuttle schedule often!\nEnjoying Skkuverse so far?',
  'feedback.reviewPrompt.positiveCta': 'Love it',
  'feedback.reviewPrompt.negativeCta': 'Could be better',
  'feedback.reviewPrompt.negativePlaceholder': 'Tell us what could be better',
  'feedback.reviewPrompt.negativeSubmit': 'Send',
  'feedback.reviewPrompt.thanks': 'Thanks for your feedback',
  'feedback.reviewPrompt.retry': "Couldn't send",
  'notices.copied': 'Copied',
  'notices.endOfList': "That's all for now",
  'notices.sectionToday': 'Today',
  'notices.sectionRecent7': 'Last 7 days',
  ...
  'onboarding.landingSubtitle': 'AI summarizes department notices for you',
  'onboarding.landingCta': 'Get started',
  'onboarding.landingExistingAccountCta': 'I already have an account',
  'onboarding.next': 'Next',
  'onboarding.skip': 'Skip',
  'onboarding.campusTitle': 'Which campus?',
  'onboarding.campusSubtitle': "We'll show only relevant notices",
  'onboarding.hsscName': 'Humanities & Social Sciences',
  'onboarding.hsscLocation': 'Myeongnyun-dong',
  'onboarding.nscName': 'Natural Sciences',
  'onboarding.nscLocation': 'Yulcheon-dong',
  'onboarding.primaryDeptTitle': 'Choose your\nprimary department',
  'onboarding.primaryDeptSubtitle': 'You can change it anytime',
  'onboarding.primaryDeptUnsupportedHelp': "My department isn't listed",
  'onboarding.deptSearchPlaceholder': 'Department name',
  'onboarding.interestDeptTitle': 'Any other departments\nyou want to follow?',
  'onboarding.interestDeptSubtitle': 'Up to 4 departments',
  'onboarding.primaryTag': 'Primary',
  'onboarding.loginTitle': 'Almost done',
  'onboarding.loginSubtitle': 'For SKKU students only —\nsign in with your school account',
  'onboarding.loginCta': 'Get started with SKKU account',
  'onboarding.summaryCampus': 'Campus',
  'onboarding.summaryPrimaryDept': 'Primary dept',
  'onboarding.summaryInterestDept': 'Interests',
  'onboarding.summaryNone': 'None',
  'onboarding.summaryPrimaryNone': 'Skipped',
  'onboarding.notificationTitle': 'Stay on top of notices',
  ...
  'onboarding.exitTitle': "You'll have to start over",
  'onboarding.exitDescription': 'Are you sure you want to leave?',
  'onboarding.exitContinue': 'Continue',
  'onboarding.exitLeave': 'Leave',
  ...
  'settings.licenses': 'Terms & Policies',
  'settings.licensesSubtitle': 'Policies & Attributions',
  'settings.tos': 'Terms of Service',
  'settings.attributions': 'Information Sources',
  ...
  'notifications.essential': 'Essential alerts',
  'notifications.services': 'Other services',
  'notifications.notices': 'Notices',
  'notifications.subscribedDepts': 'Subscribed departments',
  'notifications.editDept': 'Add or edit departments',
  ...
  'notifications.enableSheetTitle': 'Stay on top of notices',
  'notifications.enableSheetDescription': 'Get important academic and scholarship updates as push notifications',
  'notifications.enableSheetCta': 'Turn on notifications',
...
const zh: TranslationMap = {
  ...
  'auth.deleteAccountConfirmTitle': '确定注销账号？',
  'auth.deleteAccountConfirmDescription':
    '账号和数据将被永久删除。\n保存的公告和通知设置无法恢复。',
  'auth.deleteAccountNext': '下一步',
  'auth.deleteAccountAction': '注销',
  'auth.deleteAccountSkip': '跳过并注销',
  'auth.deleteAccountFeedbackTitle': '能告诉我们您离开的原因吗？',
  'auth.deleteAccountFeedbackSubtitle': '匿名收集，用于改进应用。',
  'auth.deleteAccountReason.not_used': '不常使用',
  'auth.deleteAccountReason.too_many_notifs': '通知太多',
  'auth.deleteAccountReason.no_value': '没有想要的信息',
  'auth.deleteAccountReason.bugs': '经常出错',
  'auth.deleteAccountReason.other': '其他',
  'auth.deleteAccountReason.otherPlaceholder': '请告诉我们（可选）',
  'auth.deleteAccountErrorTitle': '注销失败',
  'auth.deleteAccountError': '请稍后重试。若问题持续，请联系我们。',
  ...
  'notices.retry': '重试',
  'notices.edited': '已编辑',
  'notices.summaryFallbackAttachment': '请查看附件',
  'notices.summaryFallback': '请查看公告',
  'notices.attachments': '附件',
  'notices.preview': '预览',
  'notices.download': '下载',
  'notices.openOriginal': '打开原始页面',
  'notices.openInBrowser': '在官网查看',
  'notices.refPhone': '电话',
  'notices.refEmail': '邮箱',
  'notices.siblingPrev': '上一条',
  'notices.siblingNext': '下一条',
  'notices.siblingPrevEmpty': '没有上一条公告。',
  'notices.siblingNextEmpty': '没有下一条公告。',
  'notices.viewSource': '查看公告详情',
  'notices.sourceSheetTitle': '公告原文',
  'notices.reactionLike': '赞',
  'notices.reactionFire': '热门',
  'notices.reactionWow': '惊讶',
  'notices.reactionSad': '遗憾',
  'notices.save': '保存',
  'notices.share': '分享',
  'notices.unsave': '取消收藏',
  'notices.saved': '收藏',
  'notices.savedEmpty': '暂无收藏的公告',
  'notices.saveFailed': '保存失败',
  'notices.authRequired': '需要登录',
  'notices.deletedTombstoneTitle': '原公告已被删除',
  'notices.deletedTombstoneDescription': '学校网站上已无法查看，但你收藏的信息仍然保留。',
  'notices.deletedRemoveCta': '从收藏移除',
  'notices.deletedKeepCta': '保留',
  'notices.views': '浏览 {0}',
  ...
  'feedback.reviewPrompt.bookmarkTitle': '找到想收藏的公告了!\nSkkuverse 用得还顺手吗?',
  'feedback.reviewPrompt.shuttleTitle': '经常查看班车时刻表!\nSkkuverse 用得还顺手吗?',
  'feedback.reviewPrompt.positiveCta': '喜欢',
  'feedback.reviewPrompt.negativeCta': '可以改进',
  'feedback.reviewPrompt.negativePlaceholder': '请告诉我们哪里可以改进',
  'feedback.reviewPrompt.negativeSubmit': '发送',
  'feedback.reviewPrompt.thanks': '感谢您的宝贵意见',
  'feedback.reviewPrompt.retry': '发送失败',
  'notices.copied': '已复制',
  'notices.endOfList': '没有更多公告了',
  'notices.sectionToday': '今天',
  'notices.sectionRecent7': '近7天',
  ...
  'onboarding.landingSubtitle': 'AI为您总结院系公告',
  'onboarding.landingCta': '开始',
  'onboarding.landingExistingAccountCta': '我已经注册过',
  'onboarding.next': '下一步',
  'onboarding.skip': '跳过',
  'onboarding.campusTitle': '您在哪个校区？',
  'onboarding.campusSubtitle': '只为您显示相关公告',
  'onboarding.hsscName': '人文社会科学校区',
  'onboarding.hsscLocation': '明伦洞',
  'onboarding.nscName': '自然科学校区',
  'onboarding.nscLocation': '栗田洞',
  'onboarding.primaryDeptTitle': '请选择\n主要院系',
  'onboarding.primaryDeptSubtitle': '随时可以更改',
  'onboarding.primaryDeptUnsupportedHelp': '没有我的学院',
  'onboarding.deptSearchPlaceholder': '院系名称',
  'onboarding.interestDeptTitle': '还有其他\n想关注的院系吗？',
  'onboarding.interestDeptSubtitle': '最多可选4个',
  'onboarding.primaryTag': '主要',
  'onboarding.loginTitle': '最后一步',
  'onboarding.loginSubtitle': '仅限成均馆大学学生可见，\n请使用学校账号登录',
  'onboarding.loginCta': '使用成均馆大学账号开始',
  'onboarding.summaryCampus': '校区',
  'onboarding.summaryPrimaryDept': '主要院系',
  'onboarding.summaryInterestDept': '关注院系',
  'onboarding.summaryNone': '无',
  'onboarding.summaryPrimaryNone': '已跳过',
  'onboarding.notificationTitle': '及时收到公告',
  ...
  'onboarding.exitTitle': '退出后需要重新开始',
  'onboarding.exitDescription': '确定要退出吗？',
  'onboarding.exitContinue': '继续',
  'onboarding.exitLeave': '退出',
  ...
  'settings.licenses': '条款与政策',
  'settings.licensesSubtitle': '政策与信息来源',
  'settings.tos': '服务条款',
  ...
  'notifications.essential': '必要通知',
  'notifications.services': '其他服务',
  'notifications.notices': '公告',
  'notifications.subscribedDepts': '订阅的院系',
  'notifications.editDept': '添加 · 编辑院系',
  'notifications.permissionDenied': '通知权限已关闭',
  'notifications.permissionDeniedDesc': '请在系统设置中打开通知',
  'notifications.openSettings': '前往设置',
  'notifications.enableSheetTitle': '及时收到公告',
  'notifications.enableSheetDescription': '通过推送通知接收重要的学业和奖学金公告',
  'notifications.enableSheetCta': '开启通知',
