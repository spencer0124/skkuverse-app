...
const ko = {
  ...
  'map.compass': '정북으로 회전',
  // 캠퍼스 제안 박스. {0}은 서버가 주는 캠퍼스 이름(CampusDef.label)이라 여기 적지 않는다.
  'map.campus.suggest.switch': '{0}으로 전환할까요?',
  'map.campus.suggest.show': '가까운 {0}을 표시할까요?',
  'map.campus.suggest.action': '전환',
...
const en: TranslationMap = {
  ...
  'map.campus.suggest.switch': 'Switch to {0}?',
  'map.campus.suggest.show': 'Show {0}, the nearest campus?',
  'map.campus.suggest.action': 'Switch',
...
const zh: TranslationMap = {
  ...
  'map.compass': '转向正北',
  'map.campus.suggest.switch': '切换到{0}？',
  'map.campus.suggest.show': '显示最近的{0}？',
  'map.campus.suggest.action': '切换',
