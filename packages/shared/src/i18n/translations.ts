...
const ko = {
  ...
  'eventmap.day.nth': '{0}일차',
  'eventmap.day.both': '양일',
  'eventmap.day.every': '매일',
  'eventmap.union': '연합',
  'eventmap.tab.home': '홈',
  'eventmap.tab.menu': '메뉴',
  'eventmap.tab.info': '정보',
  'eventmap.section.intro': '소개',
  'eventmap.section.contents': '대표 콘텐츠',
  'eventmap.section.notices': '이용 안내',
  'eventmap.section.entryFee': '입장료',
  'eventmap.info.hours': '운영 시간',
  'eventmap.info.location': '위치',
  'eventmap.info.org': '운영',
  'eventmap.info.instagram': '인스타그램',
  'eventmap.info.payment': '결제 수단',
  'eventmap.highlight.menu': '대표 메뉴',
  'eventmap.menu.more': '외 {0}개',
  'eventmap.menu.disclaimer': '메뉴와 가격은 각 운영 주체가 전달한 자료를 기준으로 해요.',
  'eventmap.price': '{0}원',
  'eventmap.more': '더보기',
  'eventmap.less': '접기',
} as const;
...
const en: TranslationMap = {
  ...
  'eventmap.day.nth': 'Day {0}',
  'eventmap.day.both': 'Both days',
  'eventmap.day.every': 'Every day',
  'eventmap.union': 'Joint',
  'eventmap.tab.home': 'Home',
  'eventmap.tab.menu': 'Menu',
  'eventmap.tab.info': 'Info',
  'eventmap.section.intro': 'About',
  'eventmap.section.contents': 'Highlights',
  'eventmap.section.notices': 'Good to know',
  'eventmap.section.entryFee': 'Entry fee',
  'eventmap.info.hours': 'Hours',
  'eventmap.info.location': 'Location',
  'eventmap.info.org': 'Run by',
  'eventmap.info.instagram': 'Instagram',
  'eventmap.info.payment': 'Payment',
  'eventmap.highlight.menu': 'Menu',
  'eventmap.menu.more': '+{0} more',
  'eventmap.menu.disclaimer': 'Menus and prices are as provided by each operator.',
  'eventmap.price': '₩{0}',
  'eventmap.more': 'More',
  'eventmap.less': 'Less',
};
...
const zh: TranslationMap = {
  ...
  'eventmap.day.nth': '第{0}天',
  'eventmap.day.both': '两天',
  'eventmap.day.every': '每天',
  'eventmap.union': '联合',
  'eventmap.tab.home': '首页',
  'eventmap.tab.menu': '菜单',
  'eventmap.tab.info': '信息',
  'eventmap.section.intro': '介绍',
  'eventmap.section.contents': '主要活动',
  'eventmap.section.notices': '使用须知',
  'eventmap.section.entryFee': '入场费',
  'eventmap.info.hours': '营业时间',
  'eventmap.info.location': '位置',
  'eventmap.info.org': '运营方',
  'eventmap.info.instagram': 'Instagram',
  'eventmap.info.payment': '支付方式',
  'eventmap.highlight.menu': '招牌菜',
  'eventmap.menu.more': '另有{0}项',
  'eventmap.menu.disclaimer': '菜单和价格以各运营方提供的资料为准。',
  'eventmap.price': '{0}韩元',
  'eventmap.more': '展开',
  'eventmap.less': '收起',
};
