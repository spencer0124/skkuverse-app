...
const ko = {
  ...
  'common.retry': '다시 시도',
  'common.total': '전체',
  // 광고 슬롯 라벨. AdMob이 허용하는 표현("Ad"/"Advertisement"/"Sponsored
  // Links")만 쓸 것 — "추천"·"오늘의 혜택" 같은 오인 유발 문구는 정책 위반.
  'common.adLabel': '광고',
  ...
  'notices.done': '완료',
  'notices.accessory.searchPlaceholder': '공지에 물어보세요',
  ...
  // Placeholder rotation pool — one is picked per app session. All
  // question-shaped: the composer is a question box, not a keyword filter.
  // {0} is the active tab label; entries using it fall back to
  // `notices.accessory.searchPlaceholder` until the label resolves.
  'notices.search.hint.ask': 'AI에게 물어보세요',
  'notices.search.hint.natural': '궁금한 걸 그대로 물어보세요',
  'notices.search.hint.anything': '{0} 공지, 무엇이든',
  'notices.search.scope.all': '전체',
  'notices.search.scope.allSubtitle': '내가 보는 공지 전부',
  'notices.search.scope.sheetTitle': '어디에서 찾을까요?',
  'notices.search.resultsTitle': '검색 결과',
  'notices.search.expandToAll': '전체 공지에서 찾아보기',
  'notices.search.idle.greeting': '공지, 무엇이든 물어보세요',
  'notices.search.submit': '보내기',
  'notices.search.suggest.q1': '신청 마감 언제야?',
  'notices.search.suggest.q2': '제출 서류 뭐가 필요해?',
  'notices.search.suggest.q3': '이번 주에 새로 올라온 공지',
  'notices.answer.title': '한눈에',
  'notices.answer.more': '자세히',
  'notices.answer.less': '접기',
  'notices.answer.pending': '공지를 찾아보는 중',
  'notices.answer.abstained': '정확한 공지를 찾지 못했어요',
  'notices.answer.error': '답변을 불러오지 못했어요',
  'notices.answer.dismiss': '닫기',
...
const en: TranslationMap = {
  ...
  'notices.done': 'Done',
  'notices.accessory.searchPlaceholder': 'Ask about notices',
  ...
  'notices.search.hint.ask': 'Ask AI anything',
  'notices.search.hint.natural': 'Just ask in your own words',
  'notices.search.hint.anything': '{0} notices — ask anything',
  'notices.search.scope.all': 'All',
  'notices.search.scope.allSubtitle': 'Every notice you follow',
  'notices.search.scope.sheetTitle': 'Where should we look?',
  'notices.search.resultsTitle': 'Results',
  'notices.search.expandToAll': 'Search all notices',
  'notices.search.idle.greeting': 'Ask anything about notices',
  'notices.search.submit': 'Send',
  'notices.search.suggest.q1': 'When is the deadline?',
  'notices.search.suggest.q2': 'What documents do I need?',
  'notices.search.suggest.q3': "This week's new notices",
  'notices.answer.title': 'At a glance',
  'notices.answer.more': 'More',
  'notices.answer.less': 'Less',
  'notices.answer.pending': 'Looking through notices',
  'notices.answer.abstained': "Couldn't find a clear answer",
  'notices.answer.error': "Couldn't load the answer",
  'notices.answer.dismiss': 'Dismiss',
...
const zh: TranslationMap = {
  ...
  'notices.done': '完成',
  'notices.accessory.searchPlaceholder': '向通知提问',
  ...
  'notices.search.hint.ask': '向 AI 提问',
  'notices.search.hint.natural': '用你自己的话直接问',
  'notices.search.hint.anything': '{0}通知，随便问',
  'notices.search.scope.all': '全部',
  'notices.search.scope.allSubtitle': '我关注的所有通知',
  'notices.search.scope.sheetTitle': '要在哪里搜索？',
  'notices.search.resultsTitle': '搜索结果',
  'notices.search.expandToAll': '在全部通知中搜索',
  'notices.search.idle.greeting': '关于通知，随便问',
  'notices.search.submit': '发送',
  'notices.search.suggest.q1': '申请截止到什么时候？',
  'notices.search.suggest.q2': '需要提交哪些材料？',
  'notices.search.suggest.q3': '本周新发布的通知',
  'notices.answer.title': '一目了然',
  'notices.answer.more': '详情',
  'notices.answer.less': '收起',
  'notices.answer.pending': '正在查找通知',
  'notices.answer.abstained': '没有找到确切的通知',
  'notices.answer.error': '无法加载回答',
  'notices.answer.dismiss': '关闭',
