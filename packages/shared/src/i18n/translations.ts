...
const en: TranslationMap = {
  ...
  'notices.career': 'Career',
  'notices.recruit': 'Recruitment',
  'notices.event': 'Events',
  'notices.library': 'Library',
  'notices.dorm': 'Dormitory',
  'notices.general': 'General',
  'notices.selectDept': 'Select departments',
  'notices.selectLib': 'Select libraries',
