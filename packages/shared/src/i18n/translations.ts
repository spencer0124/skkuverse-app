...
const ko = {
  ...
  'onboarding.loginSubtitle': '잠깐 로그인하면 시작할게요',
  'onboarding.loginCta': '성균관대 계정으로 계속하기',
  'onboarding.loginFineprint': '성대생은 무료예요',
...
const en: TranslationMap = {
  ...
  'onboarding.loginSubtitle': "Quick sign-in and you're all set",
  'onboarding.loginCta': 'Continue with SKKU account',
  'onboarding.loginFineprint': 'Free for SKKU students',
...
const zh: TranslationMap = {
  ...
  'onboarding.loginSubtitle': '快速登录即可开始',
  'onboarding.loginCta': '使用成均馆大学账号继续',
  'onboarding.loginFineprint': '成大学生免费',
