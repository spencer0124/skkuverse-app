...
const ko = {
  ...
  'auth.networkError': '인터넷 연결을 확인하고 다시 시도해 주세요',
  'auth.tooManyRequests': '로그인 시도가 너무 많아요. 잠시 후 다시 시도해 주세요',
  'auth.accountUnavailable': '이 계정으로는 로그인할 수 없어요. 설정의 문의하기로 알려 주세요',
  'auth.signOut': '로그아웃',
  ...
  'notices.done': '완료',
  'notices.picker.saving': '저장 중',
  'notices.picker.saveFailed': '학과 선택을 저장하지 못했어요. 다시 시도해 주세요.',
  'notices.picker.retry': '다시 시도',
  ...
  'home.section.miniGames': '미니게임',
  'home.banner.eskaraAlt': '2026 ESKARA 초록의 파도',
  ...
  'eventmap.status.openUntil': '운영 중 · {0} 종료',
  'eventmap.status.openNoEnd': '운영 중',
  'eventmap.status.opensAt': '운영 전 · {0} 시작',
  'eventmap.hours.always': '상시 운영',
  'eventmap.kind.pub': '주점',
  'eventmap.kind.booth': '부스',
  'eventmap.kind.promo': '프로모션 부스',
  'eventmap.kind.foodTruck': '푸드트럭',
  'eventmap.kind.goods': '굿즈샵',
  'eventmap.kind.facility': '편의시설',
  'eventmap.kind.stage': '공연',
  'eventmap.kind.etc': '기타',
  'eventmap.union': '연합',
  'eventmap.info.hours': '운영 시간',
  'eventmap.info.location': '위치',
  'eventmap.info.instagram': '인스타',
  'eventmap.info.link': '링크',
  'eventmap.info.notice': '안내',
  'eventmap.menu.more': '외 {0}개',
  'eventmap.instagram': '인스타에서 자세히보기',
  'eventmap.instagram.inline': '인스타',
  'eventmap.more': '더보기',
  'eventmap.less': '접기',
  'eventmap.list.empty': '이 조건에 맞는 곳이 없어요',
  // ── Player profile & in-app games ──
  'profile.campusSubtitle': '명예의 전당에 캠퍼스가 함께 표시돼요',
  'profile.nicknameTitle': '명예의 전당에 쓸\n닉네임을 정해주세요',
  'profile.nicknameSubtitle': '모든 미니게임에서 같은 닉네임을 써요',
  'profile.nicknamePlaceholder': '닉네임',
  'profile.nicknameHelp': '한글·영문·숫자·_ 2~12자',
  'profile.nicknameInvalid': '한글·영문·숫자·_만 쓸 수 있어요',
  'profile.nicknameTooLong': '12자까지 쓸 수 있어요',
  'profile.done': '완료',
  'profile.register': '등록하기',
  'profile.saveError': '저장하지 못했어요. 잠시 후 다시 시도해주세요.',
  'game.waveRun.title': '초록의 파도',
  'game.waveRun.sub': '파도와 인자셔틀을 넘어 끝까지 달려요',
  'game.waveRun.hit.ripple': '파도에 휩쓸렸어요!',
  'game.waveRun.hit.wave': '큰 파도에 휩쓸렸어요!',
  'game.waveRun.hit.bus': '인자셔틀에 실려 갔어요!',
  'game.subwayTyping.title': '캠퍼스 타이핑',
  'game.subwayTyping.stageTitle': '혜화역에서 성균관대역까지',
  'game.subwayTyping.sub': '역 이름을 순서대로 치면 열차가 움직여요',
  'game.subwayTyping.arrived': '성균관대에 도착했어요!',
  'game.subwayTyping.kpm': '평균 타수',
  'game.subwayTyping.kpmValue': '{0}타',
  'game.subwayTyping.accuracy': '정확도',
  'game.subwayTyping.typos': '오타',
  'game.subwayTyping.typosValue': '{0}회',
  'game.waveRun.tapToStart': '화면을 눌러 시작',
  'game.best': '최고 기록 {0}',
  'game.newBest': 'NEW',
  'game.waveRun.controls.duckKey': '꾹',
  'game.waveRun.controls.duck': '누르고 있으면 숙이기\n공중에선 빨리 착지',
  'game.waveRun.controls.jumpKey': '탭',
  'game.waveRun.controls.jump': '누르면 점프 · 길게 누르면 높이\n공중에서 또 누르면 이단 점프',
  'game.paused': '잠깐 멈췄어요',
  'game.waveRun.pausedSub': '화면을 눌러 이어 달리기',
  'game.revive': '광고 보고 이어하기',
  'game.submitFailed': '등록하지 못했어요. 잠시 후 다시 시도해주세요.',
  'game.submitOtherAccount': '로그인 전 계정으로 한 판이라 등록할 수 없어요',
  'game.leaderboard': '명예의 전당 보기',
  'game.soundOn': '소리 켜기',
  'game.soundOff': '소리 끄기',
  'game.hallOfFame': '명예의 전당',
  'game.pointUnit': '점',
  'game.bestLabel': '최고 기록',
  'game.next': '다음',
  'game.rankPrompt.nicknameTitle': '닉네임을 정하면\n명예의 전당에 이름을 올릴 수 있어요',
  'game.rankPrompt.signInTitle': '로그인하면\n명예의 전당에 이름을 올릴 수 있어요',
  'game.rankPrompt.body': '이번 기록 {0}도 바로 올라가요',
  'game.rankPrompt.signInBody': '학교 Google 계정(@g.skku.edu)으로 로그인해요',
  'game.rankPrompt.nicknameCta': '닉네임 정하기',
  'game.me': '나',
  'game.projected': '예상',
  'game.rankUp': '{0}계단 올랐어요',
  'game.newEntry': '명예의 전당에 올랐어요',
  'game.leaderboardEmpty': '아직 기록이 없어요.\n첫 번째로 이름을 올려보세요!',
  'game.leaderboardError': '명예의 전당을 불러오지 못했어요',
} as const;
...
const en: TranslationMap = {
  ...
  'auth.networkError': 'Check your internet connection and try again.',
  'auth.tooManyRequests': 'Too many sign-in attempts. Please try again shortly.',
  'auth.accountUnavailable': "This account can't sign in. Let us know via Contact us in Settings.",
  ...
  'notices.done': 'Done',
  'notices.picker.saving': 'Saving',
  'notices.picker.saveFailed': "Couldn't save your department selection. Please try again.",
  'notices.picker.retry': 'Retry',
  ...
  'home.section.miniGames': 'Mini games',
  'home.banner.eskaraAlt': 'ESKARA 2026',
  ...
  'eventmap.status.openUntil': 'Open · closes at {0}',
  'eventmap.status.openNoEnd': 'Open now',
  'eventmap.status.opensAt': 'Opens at {0}',
  'eventmap.hours.always': 'Always open',
  'eventmap.kind.pub': 'Pub',
  'eventmap.kind.booth': 'Booth',
  'eventmap.kind.promo': 'Promotion booth',
  'eventmap.kind.foodTruck': 'Food truck',
  'eventmap.kind.goods': 'Merch shop',
  'eventmap.kind.facility': 'Facility',
  'eventmap.kind.stage': 'Stage',
  'eventmap.kind.etc': 'Other',
  'eventmap.union': 'Joint',
  'eventmap.info.hours': 'Hours',
  'eventmap.info.location': 'Location',
  'eventmap.info.instagram': 'Instagram',
  'eventmap.info.link': 'Link',
  'eventmap.info.notice': 'Note',
  'eventmap.menu.more': '+{0} more',
  'eventmap.instagram': 'More on Instagram',
  'eventmap.instagram.inline': 'Instagram',
  'eventmap.more': 'More',
  'eventmap.less': 'Less',
  'eventmap.list.empty': 'Nothing matches these filters',
  // ── Player profile & in-app games ──
  'profile.campusSubtitle': 'Shown with your name in the Hall of Fame',
  'profile.nicknameTitle': 'Pick a nickname\nfor the Hall of Fame',
  'profile.nicknameSubtitle': 'Every mini game uses the same one',
  'profile.nicknamePlaceholder': 'Nickname',
  'profile.nicknameHelp': '2–12 characters: Korean, letters, digits or _',
  'profile.nicknameInvalid': 'Only Korean, letters, digits and _',
  'profile.nicknameTooLong': 'Up to 12 characters',
  'profile.done': 'Done',
  'profile.register': 'Register',
  'profile.saveError': 'Couldn\'t save. Please try again in a moment.',
  'game.waveRun.title': 'Green Wave',
  'game.waveRun.sub': 'Clear the waves and the shuttle, run as far as you can',
  'game.waveRun.hit.ripple': 'Swept away by a wave!',
  'game.waveRun.hit.wave': 'Swept away by a big wave!',
  'game.waveRun.hit.bus': 'Carried off by the shuttle!',
  'game.subwayTyping.title': 'Campus Typing',
  'game.subwayTyping.stageTitle': 'Hyehwa Station to SKKU Station',
  'game.subwayTyping.sub': 'Type the stations in order to move the train',
  'game.subwayTyping.arrived': 'Arrived at Sungkyunkwan Univ.!',
  'game.subwayTyping.kpm': 'Keys per minute',
  'game.subwayTyping.kpmValue': '{0}',
  'game.subwayTyping.accuracy': 'Accuracy',
  'game.subwayTyping.typos': 'Typos',
  'game.subwayTyping.typosValue': '{0}',
  'game.waveRun.tapToStart': 'Tap to start',
  'game.best': 'Best {0}',
  'game.newBest': 'NEW',
  'game.waveRun.controls.duckKey': 'Hold',
  'game.waveRun.controls.duck': 'Hold to duck\nDrop fast in the air',
  'game.waveRun.controls.jumpKey': 'Tap',
  'game.waveRun.controls.jump': 'Tap to jump · hold to go higher\nTap again mid-air to double jump',
  'game.paused': 'Paused',
  'game.waveRun.pausedSub': 'Tap to keep running',
  'game.revive': 'Watch an ad to continue',
  'game.submitFailed': 'Couldn\'t submit. Please try again in a moment.',
  'game.submitOtherAccount': 'This run was played before signing in and can’t be submitted',
  'game.leaderboard': 'View the Hall of Fame',
  'game.soundOn': 'Turn sound on',
  'game.soundOff': 'Turn sound off',
  'game.hallOfFame': 'Hall of Fame',
  'game.pointUnit': ' pts',
  'game.bestLabel': 'Best',
  'game.next': 'Next',
  'game.rankPrompt.nicknameTitle': 'Pick a nickname to put\nyour name in the Hall of Fame',
  'game.rankPrompt.signInTitle': 'Sign in to put\nyour name in the Hall of Fame',
  'game.rankPrompt.body': 'This run ({0}) goes in too',
  'game.rankPrompt.signInBody': 'Sign in with your school Google account (@g.skku.edu)',
  'game.rankPrompt.nicknameCta': 'Pick a nickname',
  'game.me': 'Me',
  'game.projected': 'Projected',
  'game.rankUp': 'Up {0} places',
  'game.newEntry': 'You are in the Hall of Fame',
  'game.leaderboardEmpty': 'No records yet.\nBe the first in the Hall of Fame!',
  'game.leaderboardError': 'Couldn\'t load the Hall of Fame',
};
...
const zh: TranslationMap = {
  ...
  'auth.tooManyRequests': '登录尝试次数过多，请稍后再试',
  'auth.accountUnavailable': '该账号无法登录，请通过设置中的「联系我们」告知',
  'auth.signOut': '退出登录',
  ...
  'notices.done': '完成',
  'notices.picker.saving': '保存中',
  'notices.picker.saveFailed': '无法保存学科选择，请重试。',
  'notices.picker.retry': '重试',
  ...
  'eventmap.status.openUntil': '营业中 · {0}结束',
  'eventmap.status.openNoEnd': '营业中',
  'eventmap.status.opensAt': '{0}开始',
  'eventmap.hours.always': '全天开放',
  'eventmap.kind.pub': '酒馆',
  'eventmap.kind.booth': '展位',
  'eventmap.kind.promo': '推广展位',
  'eventmap.kind.foodTruck': '餐车',
  'eventmap.kind.goods': '周边商店',
  'eventmap.kind.facility': '便利设施',
  'eventmap.kind.stage': '演出',
  'eventmap.kind.etc': '其他',
  'eventmap.union': '联合',
  'eventmap.info.hours': '营业时间',
  'eventmap.info.location': '位置',
  'eventmap.info.instagram': 'Instagram',
  'eventmap.info.link': '链接',
  'eventmap.info.notice': '提示',
  'eventmap.menu.more': '另有{0}项',
  ...
  // ── Player profile & in-app games ──
  'profile.campusSubtitle': '会与昵称一起显示在名人堂中',
  'profile.nicknameTitle': '请设置\n名人堂昵称',
  'profile.nicknameSubtitle': '所有小游戏通用同一个昵称',
  'profile.nicknamePlaceholder': '昵称',
  'profile.nicknameHelp': '2–12 个字符：韩文、英文、数字或 _',
  'profile.nicknameInvalid': '只能使用韩文、英文、数字和 _',
  'profile.nicknameTooLong': '最多 12 个字符',
  'profile.done': '完成',
  'profile.register': '登记',
  'profile.saveError': '保存失败，请稍后重试。',
  'game.waveRun.title': '绿色浪潮',
  'game.waveRun.sub': '越过浪花和班车，跑得越远越好',
  'game.waveRun.hit.ripple': '被浪卷走了！',
  'game.waveRun.hit.wave': '被大浪卷走了！',
  'game.waveRun.hit.bus': '被班车带走了！',
  'game.subwayTyping.title': '校园打字',
  'game.subwayTyping.stageTitle': '从惠化站到成均馆大学站',
  'game.subwayTyping.sub': '按顺序输入站名，列车就会前进',
  'game.subwayTyping.arrived': '到达成均馆大学站了！',
  'game.subwayTyping.kpm': '平均速度',
  'game.subwayTyping.kpmValue': '{0} 键/分',
  'game.subwayTyping.accuracy': '准确率',
  'game.subwayTyping.typos': '错字',
  'game.subwayTyping.typosValue': '{0} 次',
  'game.waveRun.tapToStart': '点击屏幕开始',
  'game.best': '最高纪录 {0}',
  'game.newBest': 'NEW',
  'game.waveRun.controls.duckKey': '按住',
  'game.waveRun.controls.duck': '按住下蹲\n空中快速落地',
  'game.waveRun.controls.jumpKey': '点击',
  'game.waveRun.controls.jump': '点击跳跃 · 长按跳得更高\n空中再点击二段跳',
  'game.paused': '暂停了',
  'game.waveRun.pausedSub': '点击屏幕继续',
  'game.revive': '看广告继续',
  'game.submitFailed': '登记失败，请稍后重试。',
  'game.submitOtherAccount': '这局是在登录前的账号下玩的，无法登记',
  'game.leaderboard': '查看名人堂',
  'game.soundOn': '打开声音',
  'game.soundOff': '关闭声音',
  'game.hallOfFame': '名人堂',
  'game.pointUnit': '分',
  'game.bestLabel': '最高纪录',
  'game.next': '下一步',
  'game.rankPrompt.nicknameTitle': '设置昵称后\n即可登上名人堂',
  'game.rankPrompt.signInTitle': '登录后\n即可登上名人堂',
  'game.rankPrompt.body': '本局成绩 {0} 也会一起登榜',
  'game.rankPrompt.signInBody': '请使用学校 Google 账号（@g.skku.edu）登录',
  'game.rankPrompt.nicknameCta': '设置昵称',
  'game.me': '我',
  'game.projected': '预计',
  'game.rankUp': '上升 {0} 名',
  'game.newEntry': '已登上名人堂',
  'game.leaderboardEmpty': '还没有记录。\n来当第一个登上名人堂的人吧！',
  'game.leaderboardError': '无法加载名人堂',
};
